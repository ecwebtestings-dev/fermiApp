...
<div class="relative isolate overflow-hidden py-16 sm:py-24 lg:py-32" style="background-color: var(--color-liver);">
    <img src="https://images.unsplash.com/photo-1521737604893-d14cc237f11d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&crop=focalpoint&fp-y=.8&w=2830&h=1500&q=80&blend=5D4037&sat=-100&exp=15&blend-mode=multiply" alt="" class="absolute inset-0 -z-10 size-full object-cover object-right md:object-center" />
    ...
    <div aria-hidden="true" class="hidden sm:absolute sm:-top-10 sm:right-1/2 sm:-z-10 sm:mr-10 sm:block sm:transform-gpu sm:blur-3xl">
        <div style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%); background: var(--primary-gradient); opacity: .25;" class="aspect-1097/845 w-[274.25rem] max-w-none"></div>
    </div>
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0">
            <h2 class="text-2xl font-bold tracking-tight sm:text-3xl md:text-4xl" style="color: var(--text-white);">Protect What Matters Most</h2>
            <p class="mt-6 text-base leading-7 sm:text-lg sm:leading-8" style="color: #D7CCC8;">From CCTV surveillance and access control to structured networking and electrical installations, FERMI delivers reliable solutions that keep your home, business, and assets safe.</p>
        </div>

        <div class="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
            <div class="grid grid-cols-1 gap-x-8 gap-y-6 text-base/7 font-semibold sm:grid-cols-2 md:flex md:flex-wrap lg:gap-x-10" style="color: var(--text-white);">
                <a href="/services.php" style="color: var(--primary-orange);">Our Services <span aria-hidden="true">&rarr;</span></a>
                <a href="/projects.php" style="color: var(--primary-orange);">Our Projects <span aria-hidden="true">&rarr;</span></a>
                <a href="/services.php" style="color: var(--primary-orange);">Schedule Appointment <span aria-hidden="true">&rarr;</span></a>
                <a href="tel:+256760271098" style="color: var(--primary-orange);">Contact Us <span aria-hidden="true">&rarr;</span></a>
            </div>

            <dl class="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
                <div class="flex flex-col-reverse gap-1">
                    <dt class="text-sm sm:text-base/3" style="color: #D7CCC8;">Customer Secured</dt>
                    <dd class="text-3xl font-semibold tracking-tight sm:text-4xl" style="color: var(--text-white);">102</dd>
                </div>
                <div class="flex flex-col-reverse gap-1">
                    <dt class="text-sm sm:text-base/3" style="color: #D7CCC8;">Full-time Technical Support</dt>
                    <dd class="text-3xl font-semibold tracking-tight sm:text-4xl" style="color: var(--text-white);">24/7</dd>
                </div>
                <div class="flex flex-col-reverse gap-1">
                    <dt class="text-sm sm:text-base/3" style="color: #D7CCC8;">Years Experience</dt>
                    <dd class="text-3xl font-semibold tracking-tight sm:text-4xl" style="color: var(--text-white);">10</dd>
                </div>
                <div class="flex flex-col-reverse gap-1">
                    <dt class="text-sm sm:text-base/3" style="color: #D7CCC8;">Unlimited</dt>
                    <dd class="text-3xl font-semibold tracking-tight sm:text-4xl" style="color: var(--text-white);">Service</dd>
                </div>
            </dl>
        </div>
    </div>
